...
- Crea un Daemonset siguiendo la demostración que se muestra en el vídeo.
- Familiarízate con la sintaxis de cron y crea un objeto cronjob en Kubernetes que muestre el mensaje «40daysofkubernetes» cada 5 minutos, utilizando la imagen de BusyBox.
